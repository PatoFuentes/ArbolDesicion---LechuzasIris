...
# Potencia es la variable objetivo, mientras que los demás campos son características
X = dataset[['Radiacion', 'Temperatura', 'Temperatura panel']]
y = dataset['Potencia']
...
tree.plot_tree(modelo, filled=True, feature_names=X.columns, class_names=[str(cls) for cls in y.unique()])
plt.show()
